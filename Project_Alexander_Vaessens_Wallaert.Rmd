...
Multiple methods for exploration and visualisation of high dimensional data were applied (sparse PCA, MDS, sparse LDA, LLE, ISOMAP, Sammon Mapping, Diffusion maps, and t-SNE), yet without clear results. The main conclusion are reported here, while details of these results can be found in appendices \ref{sparse pca} to \ref{tsne}. 
...
The results of the sparse LDA gave the best results in the sense that it was possible to make a distinction between groups, but not without a substantial overlap. 
