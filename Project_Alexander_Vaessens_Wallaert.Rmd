...
```{r, results = "asis"}
abbreviation <- c('AUC','IQR', 'LDA', 'LASSO', 'LLE', 'PCA', 'ROC curve', 'sd', 't-SNE')
meaning <-
...
```{r plots-mds, fig.cap="Scree plot"}
...
```{r lle, fig.cap="LLE", fig.pos="hold", out.width="50%"}
...
```{r ISOMAP, fig.cap="ISOMAP", fig.pos="hold", out.width="50%"}
...
```{r sammon, fig.cap="Sammon mapping", fig.pos="hold", out.width="50%"}
...
```{r diffusion, fig.cap="Diffusion map"}
