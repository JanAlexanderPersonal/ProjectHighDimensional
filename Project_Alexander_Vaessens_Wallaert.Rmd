...
From the 3 modeling approaches used in this study, the LASSO regression gave the best results in both terms of AUC on the test data and in terms of parsimony.  Interestingly, from the selected genes by the LASSO model, the genes `r intersect(best_all, lasso_selection)` were also detected by the sparse LDA.
