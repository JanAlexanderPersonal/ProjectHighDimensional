...
In figure \@ref(fig:lasso), one can see that for $\gamma$ equal to `r round(m.cv$lambda.min, digits = 2)`, the cross validated _AUC_ is maximal for the train dataset based on a 10-fold cross-validation over the train dataset.  
