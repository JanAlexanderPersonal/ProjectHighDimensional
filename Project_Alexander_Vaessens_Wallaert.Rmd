...
of the genes: `r unique(summary(coef(m))[-1,1])`.
Compared to the interesting genes found with the Sparse LDA method: `r intersect(unique(summary(coef(m))[-1,1]), best_116)`
